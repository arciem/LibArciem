...
#ifndef ARCIEM_POINT2_H
#define ARCIEM_POINT2_H
...
#pragma clang diagnostic pop
	...
	double distance(point2 const& p) const { return distance2(p.x - x, p.y - y); }
	double distance_squared(point2 const& p) const { return distance_squared2(p.x - x, p.y - y); }
