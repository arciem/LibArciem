...
#ifndef ARCIEM_POINT3_H
#define ARCIEM_POINT3_H
...
#pragma clang diagnostic pop
	...
	double distance(point3 const& p) const { return distance3(p.x - x, p.y - y, p.z - z); }
	double distance_squared(point3 const& p) const { return distance_squared3(p.x - x, p.y - y, p.z - z); }
