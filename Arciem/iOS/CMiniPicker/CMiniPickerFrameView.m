...
- (void)drawRect:(CGRect)rect
{
    ...
    ContextFillRectGradientVertical(context, bevelRect, self.bevelGradientRef, NO);
    ...
    ContextFillPathGradientVertical(context, maskPath.CGPath, self.frameGradientRef, NO);
