...
- (instancetype)initWithAtlasImage:(CTextureAtlasImage *)atlasImage dictionary:(NSDictionary *)dict {
    if(self = [super init]) {
        ...
        _name = dict[@"name"];
        _name = [sRemoveExtensionRegularExpression stringByReplacingMatchesInString:_name options:(NSMatchingOptions)0 range:NSMakeRange(0, _name.length) withTemplate:@"$1" ];
