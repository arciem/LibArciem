...
{
	return [[[CDimension alloc] initWithIdentifier:identifier name:name] autorelease];
}
...
{
	return [[[CUnit alloc] initWithSymbol:symbol name:name dimension:dimension] autorelease];
}
